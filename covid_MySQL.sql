SELECT * 
FROM cov_death    #COVID_DEATH.CSV contains details about daily cases, deaths and population     
ORDER BY 3,4                                   
 
SELECT * 
FROM cov_vac        #COVID_VAC.CSV contains info regarding vaccinations and covid tests 
ORDER BY 3,4                                    
